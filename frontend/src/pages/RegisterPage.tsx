...
/**
 * RegisterPage component: Combines user registration and login forms in a single page.
 */
const RegisterPage = () => {
   ...
   * - Provides user feedback and resets the form.
   ...
   * - Stores authentication token and user ID in localStorage.
